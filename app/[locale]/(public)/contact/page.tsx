              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">{t('phone.value')}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">{t('opd.value')}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">{t('emergency.value')}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
